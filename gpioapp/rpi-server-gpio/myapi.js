...
*
* DESCRIPTION:
* API Appserver on a Raspberry Pi to access GPIO I/O and ADC channels
* Uses the Express, wiringPi node packages and the python ADCPi library.
*
*
* @author Juan Greco (@jgrecoarroyo)
*/
...
app.get('/adcs', function (req, res) {
  ...
  var url = 'http://localhost:8003/adcs';
